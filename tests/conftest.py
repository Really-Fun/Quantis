...
# Буфер стриминга живёт в tempfile.gettempdir()/quantis_stream и чистит там
# чужие файлы — общий /tmp ломал параллельные прогоны и играющий Quantis.
tempfile.tempdir = tempfile.mkdtemp(prefix="quantis-test-tmp-")
