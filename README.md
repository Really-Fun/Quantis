...
| **Прозрачная** | Интерфейс почти без подложек: фон виден сквозь панели |
...
| **Полночь** | Глубокий синий, холодный ледяной акцент |

Своя тема — один файл в `src/quantis/ui/themes/`, см. [docs/themes.md](docs/themes.md).
